(function ($) {
	...
	$.su.CHAR = {
		VTYPETEXT: {
			...
			PWD: 'Invalid format.',
			NAME: 'Invalid format.',
			NAME_START: 'Invalid format.', //not exit in su1.0
			...
			DEVICE_NAME_INVALID: 'Devicename should only contain A~z or 0~9 or "-" or "_"',
		...
		COMMON: {
			...
			NA: 'Not Available',
			DELETE_CONFIRM_CONTENT: 'Are you sure you want to delete the selected entry?',
